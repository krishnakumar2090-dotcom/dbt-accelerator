...
st.set_page_config(
    ...
    page_icon="EY",  # Can be replaced with your favicon
    layout="wide"
)
...
with col1:
    st.image("logo.png", width=80)  # Replace with your local logo path

with col2:
    st.markdown("<h1 style='text-align: center; margin-bottom: 0;'>DBT Model Generator Agent</h1>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center;'>Upload your S2T mapping Excel file and generate DBT-compliant SQL + YAML.</p>", unsafe_allow_html=True)
